...
export default function NewsCard({
  ...
  return (
    <div className={`news-card ${previewActive ? 'preview-active' : ''}`} onClick={onClick} role="button" tabIndex={0} onKeyDown={e => e.key === 'Enter' && onClick()}>
      ...
      <div className="news-card-bottom">
        ...
        <div className="news-card-actions">
          {onPreview && (
            <button
              type="button"
              className={`news-page-view-btn ${previewActive ? 'active' : ''}`}
              onClick={(event) => {
